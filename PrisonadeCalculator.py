...
if mix == ("Valley Mix"):
    ...
    st.title(f"You need {total1} T3 {block1n} ({total1stack} stacks and {total1stackleft} blocks) and {total2} T3 {block2n} ({total2stack} stacks and {total2stackleft} blocks)")
elif mix != ("Peak Mix"):  
    block1 = float(block1)
    block2 = float(block2)
    total1 = round(block1 * blocks)
